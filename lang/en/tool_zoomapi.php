...
$string['cachedef_token'] = 'OAuth access tokens';
$string['cachedef_unresolved'] = 'Identifiers confirmed to not have a Zoom account';
$string['cachedef_users'] = 'Zoom user lookups';
